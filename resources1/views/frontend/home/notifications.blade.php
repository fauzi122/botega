                    ...
                    <div class="col-lg-3" style="margin-bottom: 30px">
                        ...
                        <div class="single-sidebar-widget">
                            ...
                            <ul class="single-sidebar-widget__dropdown" id="single-sidebar-widget__dropdown">
                                <li><a href="{{url('notifications')}}" style="color: orange"><i class="bx bx-book"></i>
                                        Belum Dibaca</a></li>
                                <li><a href="{{url('notificationss')}}"><i class="bx bx-book-open"></i> Sudah Dibaca</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-lg-9">
                        <div class="faq-wrapper">
                            <div class="single-faq">
                                <h4 class="faq-title"><i class="bx bx-book"></i> Belum Dibaca</h4>
                                <div class="accordion row" id="shippingInfo">
                                    @foreach($list as $l)
                                        ...
                                        <a href="{{url('ceknotif/'.Crypt::encrypt($l->id))}}">
                                            <div
                                                style="border: 1px solid #cccce0; border-radius: 8px; padding: 15px; margin: 5px; background-color: ghostwhite">
                                                <div>
                                                    <h4>{{$l->actions}}</h4>
