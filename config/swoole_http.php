    ...
    */
    'server' => [
        ...
        'options' => [
            ...
            'reactor_num' => 15, //env('SWOOLE_HTTP_REACTOR_NUM', swoole_cpu_num()),
            'worker_num' => 15, //env('SWOOLE_HTTP_WORKER_NUM', swoole_cpu_num()),
            'task_worker_num' => 15, //env('SWOOLE_HTTP_TASK_WORKER_NUM', swoole_cpu_num()),
...
//            'task_timeout' => 300,
    ...
    */
    'websocket' => [
        'enabled' => false //env('SWOOLE_HTTP_WEBSOCKET', true),
    ],
