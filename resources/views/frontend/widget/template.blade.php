                    ...
                    <div class="header-info-wrapper header-info-wrapper--alt-style">
                        ...
                        <div class="header-logo">
                            <a href="{{url('home')}}">
                                ...
                                @endif
                                <img src="{{asset('')}}assets_frontend/img/bottega-brown.png" class="img-fluid" alt=""
                        ...
                        <div class="header-navigation-wrapper">
                            <nav>
                                <ul>
                                    ...
                                    <li class="has {{ isset($product) ? 'active' : '' }}"><a href="{{url('product')}}">PRODUCT</a>
                        ...
                        @if(session('user'))
                            <div class="header-icon-area">
                                ...
                                <div class="account-dropdown d-flex align-items-center">
                                    <a href="" style="color: black">Selamat Datang, {{session('user')->first_name}} <i
                                        ...
                                        <li>
                                            ...
                                            <div class="container">
                                                <div class="minicart-wrapper">
                                                    ...
                                                    <div class="minicart-wrapper__items ps-scroll" id="notification-items">
                                                        <!-- Di sini akan ditampilkan notifikasi -->
                                                    </div>
                                                    <div class="minicart-wrapper__buttons mb-0">
                                                        <a href="{{ url('notifications') }}" class="theme-button theme-button--minicart-button mb-0">VIEW NOTIFICATIONS</a>
                                                    </div>
                                                </div>
                                            </div>
                                            @endif
                ...
                <div class="off-canvas-contact-widget">
                    <div class="header-contact-info">
                        <ul class="header-contact-info__list">
                            <li style="font-weight: bold">{{session('user')->first_name}} {{session('user')->last_name}} </li>
                            <li><i class="fa fa-user"></i> <a href="{{url('profile')}}" title="">My Profile </a></li>
                            <li><i class="fa fa-gear"></i> <a href="{{url('ubahpassword')}}" title="">Ubah Password </a>
                            </li>
                            <li><i class="fa fa-arrow-circle-left"></i> <a href="javascript:void(0)" id="labelLogout">Logout </a>
                            </li>
...
<div id="qv-1" class="cd-quick-view">
    <div class="cd-slider-wrapper">
        ...
        <ul class="cd-slider">
            <li class="selected"><img src="{{asset('')}}assets_frontend/img/products/product-9-1-600x800.jpg"
                                      alt="Product 2"></li>
            <li><img src="{{asset('')}}assets_frontend/img/products/product-9-2-600x800.jpg" alt="Product 1"></li>
        </ul> <!-- cd-slider -->
    ...
    <div class="quickview-item-info cd-item-info ps-scroll">
        ...
        <p class="description">Upholstered velvet ottoman with antique stud detailing. Invite restrained glamour and
...
<script type="text/javascript"
        src="{{asset('')}}assets_frontend/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
<script type="text/javascript"
