                    ...
                    <div class="w-100">
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="auth-content my-auto">
                                ...
                                <form class="mt-4 pt-2" method="post" action="{{ url('login/resetpasslama')  }}">
                                    @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="password" class="form-control"
                                                       ...
                                                       id="confirmPassword">
                                                <code id="passwordMismatch" style="color: red; display: none;">Password
                                                    konfirmasi tidak sama</code>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mb-3">
                                        <button class="btn btn-primary w-100 waves-effect waves-light"
                                                id="registerButton" type="submit">Reset Password
                                        </button>
                                    </div>
                                </form>
