                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-6">
                                ...
                                <h4 class="mb-3">
                                    <i class="fa fa-user-circle"></i> <span class="counter-value" data-target="{{ $resume[\App\Models\ResumeDashboardModel::JML_MEMBER] ?? '' }}">0</span>
                                </h4>
                            </div>
                        ...
                        <div class="text-nowrap">
                            <span class="badge bg-success-subtle text-success">+{{ $resume[\App\Models\ResumeDashboardModel::JML_MEMBER_BARU]  ?? '' }}</span>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-6">
                                ...
                                <h4 class="mb-3">
                                    <i class="mdi mdi-cart text-info"></i> <span class="counter-value" data-target="{{ $resume[\App\Models\ResumeDashboardModel::JML_PENJUALAN] ?? '' }}">0</span>
                                </h4>
                            </div>
                            <div class="col-6">
                                @php
                                    $p2l = $resume[\App\Models\ResumeDashboardModel::JML_PENJUALAN_2PEKAN_LALU] ?? 0;
                                    $pl = $resume[\App\Models\ResumeDashboardModel::JML_PENJUALAN_PEKAN_LALU] ?? 0;
                                    $stt = $p2l > $pl ? 'bg-danger-subtle text-danger' : 'bg-success-subtle text-success';
                                @endphp
                                <div id="mini-chart2" data-colors='["#5156be"]' class="apex-charts mb-2"></div>
                            </div>
                        </div>
                        <div class="text-nowrap">
                            <span class="badge {{$stt}}"> {{ $resume[\App\Models\ResumeDashboardModel::JML_PENJUALAN_PEKAN_LALU] ?? 0 }} Trades</span>
                            <span class="ms-1 text-muted font-size-13">Since last week</span>
                        </div>
                    </div><!-- end card body -->
                </div><!-- end card -->
            ...
            <div class="col-xl-3 col-md-6">
                ...
                <div class="card card-h-100">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Total Trades</span>
                                <h4 class="mb-3">
                                    @php
                                        $satuan = '';
                                         $totalpenjualan = doubleval($resume[\App\Models\ResumeDashboardModel::TOTAL_PENJUALAN] ?? 0);
                                         if($totalpenjualan >= 1000000000){
                                             $satuan = 'M';
                                             $totalpenjualan = $totalpenjualan / 1000000000;
                                         }else if($totalpenjualan >= 1000000){
                                             $satuan = 'Jt';
                                             $totalpenjualan = $totalpenjualan / 1000000;
                                         }else if($totalpenjualan >= 1000){
                                             $satuan = 'Rb';
                                             $totalpenjualan = $totalpenjualan / 1000;
                                         }
                                    @endphp
                                    <i class="fa fa-money-bill text-success"></i> IDR <span class="counter-value" data-target="{{ round($totalpenjualan,2) }}">0</span> {{$satuan}}
                                </h4>
                            </div>
                            <div class="col-6">
                        ...
                        <div class="text-nowrap">
                            @php
                                $satuan = '';
                                 $totalpenjualan = doubleval($resume[\App\Models\ResumeDashboardModel::TOTAL_PENJUALAN_TAHUN_INI] ?? 0);
                                 if($totalpenjualan >= 1000000000){
                                     $satuan = 'M';
                                     $totalpenjualan = $totalpenjualan / 1000000000;
                                 }else if($totalpenjualan >= 1000000){
                            ...
                            <span class="badge bg-success-subtle text-success"> {{ round($totalpenjualan,2) }} {{$satuan}}</span>
                        ...
                        <div class="row align-items-center">
                            <div class="col-6">
                                ...
                                <h4 class="mb-3">
                                    @php
                                        $satuan = '';
                                         $totalfee = doubleval($resume[\App\Models\ResumeDashboardModel::TOTAL_FEE] ?? 0);
                                         if($totalfee >= 1000000000){
                                             $satuan = 'Mly';
                                             $totalfee = $totalfee / 1000000000;
                                   ...
                                   IDR <span class="counter-value" data-target="{{round($totalfee,2)}}">0</span> {{$satuan}}
                                </h4>
                            </div>
                            <div class="col-6">
