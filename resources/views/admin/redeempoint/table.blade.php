            ...
            <div class="card-body">
                ...
                <ul class="nav nav-tabs-custom card-header-tabs" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link px-3 active" data-bs-toggle="tab" href="#tab" role="tab" aria-selected="true">
                            Pengajuan
                    ...
                    <!-- Tab: Proses -->
                    <li class="nav-item" role="presentation">
                        <a class="nav-link px-3" data-bs-toggle="tab" href="#tab-proses" role="tab" aria-selected="false">
                            Proses
                    ...
                    <!-- Tab: Disetujui -->
                    <li class="nav-item" role="presentation">
                        <a class="nav-link px-3" data-bs-toggle="tab" href="#tab-acc" role="tab" aria-selected="false">
                            Disetujui
                    ...
                    <!-- Tab: Ditolak -->
                    <li class="nav-item" role="presentation">
                        <a class="nav-link px-3" data-bs-toggle="tab" href="#tab-tolak" role="tab" aria-selected="false">
                            Ditolak
