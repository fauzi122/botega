        ...
        <div id="rev_slider_26_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.7">
            <ul>
                ...
                @foreach($sliders as $sl)
                    @php
                        $transitions = ['slideoverdown', 'slidingoverlayvertical', 'cube-horizontal', '3dcurtain-vertical', 'parallaxtoright', 'parallaxtoleft', 'parallaxtotop', 'parallaxtobottom', 'parallaxhorizontal', 'slidingoverlaydown', 'slidingoverlayleft', 'slidingoverlayright', 'slidingoverlayhorizontal'];
                    ...
                    <li data-index="rs-{{$loop->iteration}}" data-transition="{{ $randomTransition }}"
                        ...
                        <!-- MAIN IMAGE -->
                        <img src="{{url('fslider/image/'.$sl->id.'.png')}}" alt="" width="1920" height="1080"
                        ...
                        <div class="tp-caption   tp-resizeme" id="slide-{{$loop->iteration}}-layer-3"
                             ...
                             data-color="['rgba(17,17,17,0.4)','rgb(0,0,0)','rgb(0,0,0)','rgb(0,0,0)']"
