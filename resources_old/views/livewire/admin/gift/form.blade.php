                    ...
                    <form id="form_data" wire:submit.prevent>
                        <div class="form-group mb-3">
                            ...
                            <div wire:ignore>
                                <select id="user_id" name="user_id"
                                        ...
                                        class="select2bind @error('user_id') is-invalid @enderror">
                                </select>
                            </div>
                       ...
                       <div class="row mb-3">
                           <div class="form-group col-md-6">
                               ...
                               <select wire:change="dapatHarga" id="gift_type_id" name="gift_type_id" class="form-select @error('gift_type_id') is-invalid @enderror" wire:model="gift_type_id">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="date" id="sent_at" name="sent_at" class="form-control @error('sent_at') is-invalid @enderror" wire:model="sent_at" />
                            @error('sent_at')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="date" id="sent_at" name="sent_at" class="form-control @error('received_at') is-invalid @enderror" wire:model="received_at" />
                            @error('received_at')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
