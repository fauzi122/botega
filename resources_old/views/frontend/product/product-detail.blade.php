                                    ...
                                    <div class="big-image-wrapper">
                                        ...
                                        <div class="product-details-big-image-slider-wrapper product-details-big-image-slider-wrapper--side-space theme-slick-slider" data-slick-setting='{
                                            ...
                                            <div class="single-image">
                                                <img src="{{ url('produk-img/image/'.$r->idimage.'.png') }}" class="img-fluid" alt="" style="border-radius: 10px; object-fit: cover; width: 100%; height: 600px; border: 1px solid #7d5e28;" onerror="this.src='{{ asset('assets_frontend/img/noimage.png') }}'">
                                            </div>
                                            @endforeach
...
{{--                                            tes--}}
                                            <div class="single-image">
                                                <img src="{{ url('produk-img/image/'.$r->idimage.'.png') }}" class="img-fluid" alt="" style="border-radius: 10px; object-fit: cover; width: 100%; height: 190px; border: 1px solid #7d5e28;" onerror="this.src='{{ asset('assets_frontend/img/noimage.png') }}'">
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
                                    ...
                                    <tr class="single-info">
                                        ...
                                        <td class="quickview-value">
                                            <ul class="quickview-social-icons">
                                                <li><a href="https://www.facebook.com/sharer/sharer.php?u={{ url('product-detail/' . \Illuminate\Support\Facades\Crypt::encrypt($result[0]->id)) }}" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                                <li><a href="https://twitter.com/intent/tweet?url={{ url('product-detail/' . \Illuminate\Support\Facades\Crypt::encrypt($result[0]->id)) }}" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                                <li><a href="https://plus.google.com/share?url={{ url('product-detail/' . \Illuminate\Support\Facades\Crypt::encrypt($result[0]->id)) }}" target="_blank"><i class="fa fa-google-plus"></i></a></li>
                                                <li><a href="https://pinterest.com/pin/create/button/?url={{ url('product-detail/' . \Illuminate\Support\Facades\Crypt::encrypt($result[0]->id)) }}" target="_blank"><i class="fa fa-pinterest"></i></a></li>
                                                <li><a href="whatsapp://send?text={{ url('product-detail/' . \Illuminate\Support\Facades\Crypt::encrypt($result[0]->id)) }}" target="_blank"><i class="fa fa-whatsapp"></i></a></li>
        ...
        <div class="single-product-description-tab-area section-space">
            ...
            <div class="description-tab-navigation">
                <ul class="nav nav-tabs justify-content-center" id="nav-tab2" role="tablist">
                    <li class="nav-item">
                        <button class="nav-link active" id="description-tab" type="button" data-bs-toggle="tab" data-bs-target="#product-description" role="tab"  aria-controls="product-description" aria-selected="true">DESCRIPTION</button>
                    </li>

                    <li class="nav-item">
                        <button class="nav-link" id="review-tab" data-bs-toggle="tab" data-bs-target="#product-review" role="tab"  aria-controls="product-review" aria-selected="false">REVIEWS ({{$komentar->count()}})</button>
                    </li>
                </ul>
            </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="review-content-wrapper">
                                        ...
                                        <div class="review-comments">
                                            ...
                                            <h4 class="review-comment-title">{{$komentar->count()}} REVIEWS FOR {{$result[0]->name}}</h4>
                                            ...
                                            <div class="single-review-comment">
                                                ...
                                                <div class="single-review-comment__content">
                                                    <div class="review-time"><i class="fa fa-calendar"></i>{{ \Carbon\Carbon::parse($kom->created_at)->locale('id_ID')->isoFormat('D MMMM YYYY, H:mm')}}</div>
                                        ...
                                        <div class="review-comment-form">
                                            ...
                                            <form action="{{url('komentar-produk')}}" method="post">
                                                @csrf
                                                <input type="hidden" name="id" value="{{Crypt::encrypt($result[0]->id)}}" id="">
