    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Laporan Outstanding Fee</h4>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Outstanding Fee</h4>
                    <p class="card-title-desc">
                        Daftar pembayaran fee yang masih tersisa.
                    </p>
                </div>
                <div class="card-body">
                    <div class="table-responsive table-responsive-md m-t-40">
                        <table id="jd-table"
                               ...
                               data-datasource = "{{url('admin/fee/data-source-outstanding')}}"
