        ...
        let menu = [
            ...
            },
            {
                ...
                "sub-menu": [
                    ...
                    {
                        title: "Payment Made",
                        url: baseurl + "/payment-made/",
                        icon: "credit-card",
                    },
                    {
                        title: "Outstanding Fee",
                        url: baseurl + "/fee/report-outstanding/",
                        icon: "bar-chart",
                    },
                ],
            },
            {
                ...
                "sub-menu": [
                    {
                        title: "Fee Per Member",
                        url: baseurl + "/report/fee-member/",
                        icon: "users",
                    },
                    {
                        title: "Fee Per Kategori",
                        url: baseurl + "/report/fee-kategori/",
                        icon: "shopping-bag",
                    },
                    {
                        title: "Fee Per Merk",
                        url: baseurl + "/report/fee-merk/",
                        icon: "flag",
                    },
                ],
            },
        ...
        menu.forEach(function (v, i, a) {
            ...
            if (v.class === "menu-title") {
                ...
                let icon =
                    v.icon === undefined
                        ? ""
                        : `<i class="${iclass}" data-feather="${v.icon}"></i>`;
                tmp += `<a href="${
                    v.url ?? "javascript:void(0)"
                }">${icon} <span class="${classname}" data-key="${key}">${
                    v.title ?? ""
                }</span></a>`;
            }
            if (submenu) {
