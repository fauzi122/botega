...
function createURLGridView(start=0){
    ...
    var baseurl = $('meta[name=baseurl]').attr('content') + '/admin/produk-image/data-source/?id='+produkid;
    ...
    return baseurl + searchQuery + `&start=${start}&length=8&search[value]=`+ encodeURI(cari)
}
